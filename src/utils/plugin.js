...
tjjPlugin.install = function (vue, options) {
     ...
     * @returns {*}
     */
    vue.prototype.format = function (formatTime, formatType) {
        ...
        return new Date(formatTime.toString().replace(/-/g,'/')).Format(formatType) // "yyyy年MM月dd日 hh:mm:ss 星期w"
    }
